...
public class GenerateMain {
    ...
    static final String EXE = "java -jar sikuli-slides-1.7.jar generate";
    ...
    void parseArgs(String... args) throws IllegalArgumentException {
        ...
        // Defer help printing to execute(); don't require input when help is requested
        if (help){
            helpRequested = true;
            return;
        }
    ...
    public void execute(String... args){
        ...
        // If help requested, print usage and exit cleanly
        if (helpRequested) {
            Args.usage(this, EXE + " " + SYNTAX);
            return;
        }
